const translations = {
  ...
  mfe: {
    page: {
      title: {
        home: 'Facture.mu – Leldorado faktirasyon',
        pricing: 'Facture.mu – Pri'
      }
    },
    nav: {
      home: 'Akèy Facture.mu',
      features: 'Fonksionnalite',
      pricing: 'Pri',
      faq: 'FAQ',
      contact: 'Kontak'
    },
    actions: {
      login: 'Konekte',
      free_trial: '15 zour esai gratis'
    },
    hero: {
      title: 'Faktirasyon senp ek entelizan pou bann antrepriz Moris 🇲🇺',
      subtitle: 'Pas mwins letan pou faktire ek plis letan pou devlop ou biznes avek enn faktirasyon profesyonnel, plizir lang ek plizir devis.',
      demo: 'Vwar demo',
      features_link: 'Vwar bann fonksionnalite',
      tagline: 'Fini krwar pou bann antrepriz ki opere Moris ek plis lwen',
      quote: '« pli fasil ek pli vit ki Excel ! »'
    },
    features: {
      title: 'Tou seki ou bizin pou faktire anpaz',
      subtitle: 'Enn platform modern pou lekosistem biznes Moris ek internasyonal',
      items: {
        quotes: 'Devi ek fakti personalize',
        export: 'Ekspor ek impor ou done',
        send: 'Anvoi par email ek WhatsApp',
        currencies: '+160 devis',
        languages: 'Plizir lang',
        reminders: 'Rappel otomatik'
      }
    },
    functionalities: {
      title: 'Fonksionnalite',
      subtitle: 'Enn platform modern avek bann fonksionnalite kle pou zere faktirasyon lokal ek internasyonal.',
      items: {
        one: 'Fer devi, fakti ek resi',
        two: 'Transforme devi an fakti',
        three: 'Avoy zot par email ouswa WhatsApp',
        four: 'Swiv peyman bann fakti',
        five: 'Rapel bann impaye otomatikman',
        six: 'Personnaliz design bann fakti',
        seven: 'Donn aksè ar ou kolaborater'
      }
    },
    activity: {
      title: 'Pou ou aktivite',
      subtitle: 'Enn platform panse pou bann antrepriz, kabine ek endepandan ki opere Moris ek internasyonal.',
      heading: 'Logiciel faktirasyon gratis ki finn kree pou freelancer, konsiltan, endepandan ek pti antrepriz.',
      body: 'Faktirasyon pou freelancer ek antrepriz tou grander.<br><br>Projete enn zimaz profesyonnel avek bann fakti byen desine ek anliny ar ou mark. Gagn letan gras a anvoi otomatik, swivi peyman ek rappel amikal kan peyman an retard.',
      cta: '15 zour esai gratis'
    },
    usecases: {
      retail: {
        title: 'Detayan / Distribiter',
        before: 'Avan',
        before_items: [
          'Raport lavant depi bann fakti',
          'Zestion stok dan bann fich kalkil',
          'Server lokal, krwar zis dan biro',
          'Pa kapav sible bann group kliyan pou piblisite'
        ],
        after_items: [
          'Done dan cloud, krwar partou',
          'Analiz entelizan pou profiter done',
          'Idantifie bann kliyan performan'
        ],
        result: '👉🏽  <strong>+20 % sif d’affaires sa lane-la</strong>'
      },
      services: {
        title: 'Antrepriz servis',
        before: 'Avan',
        before_items: [
          'Faktirasyon ek depans dan sistenm separe',
          'Retar peyman preske toultan'
        ],
        after_items: [
          'Faktirasyon rekiran otomatik',
          'Anvoi par email ouswa WhatsApp',
          'Rappel otomatik = trésorerie pli bon'
        ],
        result: '👉🏽  <strong>pa gagn souci trésorerie</strong>'
      },
      sme: {
        title: 'PME',
        before: 'Avan',
        before_items: [
          'Expert-kontab ser',
          'Retar TVA ek peyman fourniser'
        ],
        after_items: [
          'Aksè partaze ar expert-kontab',
          'Fakti scan ek santralize'
        ],
        result: '👉🏽  <strong>trésorerie pli prop ek peyman a ler</strong>'
      },
      footer: 'Facture.mu permet ou otomatikman ek rasyonaliz faktirasyon, zestion depans ek analiz komersyal.<br><strong>Rezilta : enn trésorerie pli saine ek plis reveni.</strong>'
    },
    testimonials: {
      title: 'Temwagnaz',
      subtitle: 'Enn solision faktirasyon ki bann antrepriz ek endepandan krwar ladan.',
      items: {
        one: {
          text: 'Facture.mu inn sanze fason nou zere klub. Tou pli kler, pli organize, ek nou pas mwins letan lor administratif.',
          by: 'Stéphanie depi'
        },
        two: {
          text: 'Gras a Facture.mu, nou pas mwins letan lor administratif ek plis letan pou ed bann zanimo. Zestion pli kler, pli organize ek pli serein.',
          by: 'Audrey depi'
        },
        three: {
          text: 'Gras a Facture.mu, La Vanilleraie Vanillart kapav zere lavant dan plizir devis fasilman. Faktirasyon kler, bien organize, ek li les nou konsantre lor nou metie principal: vaniy.',
          by: 'Dhareena depi'
        }
      }
    },
    pricing: {
      ...
      plans: {
        start: {
          name: 'Koumansman',
          price: 'Gratis',
          equivalent: 'Wi, gratis',
          features: [
            '1 itilizater',
            'Ziska 5 kliyan',
            'Fakti ek devi san limit',
            'Dokiman avek ou logo'
          ],
          cta: 'Anrezistre'
        },
        grow: {
      ...
      view_all: 'Vwar tou pri'
    },
    final_cta: {
      title: 'Koumans faktire aster!',
      subtitle: 'Faktire ou kliyan, gagn peyman pli vit!',
      cta: '15 zour esai gratis'
    },
    faq: {
      title: 'Kestion souvan',
      subtitle: 'Poz nou ou kestion',
      items: {
        one: {
          question: 'Mo antrepriz pa anrezistre Moris, eski mo kapav servi Facture.mu?',
          answer: 'Wi. Facture.mu kapav servi par antrepriz ki anrezistre Moris ek aletranze. Ou kapav faktire dan plizir devis ek lang.'
        },
        two: {
          question: 'Eski mo kapav faktire dan diferan devis (USD, EUR, MUR, etc.)?',
          answer: 'Wi. Facture.mu siport plis ki 160 devis avek diferan fason afiche ek to, adapte pou bezwin lokal ek internasyonal.'
        },
        three: {
          question: 'Eski mo kapav import mo done depi mo sistenm aktyel?',
          answer: 'Wi, ou kapav import ou kliyan ek ou atik an format Excel.'
        },
        four: {
          question: 'Eski mo kapav zere TVA avek Facture.mu?',
          answer: 'Wi. Facture.mu permet ou faktire avek ouswa san TVA, definir plizir to si bizin, azout frais ek remiz osi.'
        },
        five: {
          question: 'Eski mo kapav servi mo logo ek mo bann koulèr mark?',
          answer: 'Wi, ou kapav personnaliz ou fakti avek ou logo, ou koulèr ek mem modifie/azout lenformasion lor ou dokiman.'
        },
        six: {
          question: 'Eski mo kapav export mo done?',
          answer: 'Byin sir. Tou ou done kapav export a nenport moman an PDF ouswa Excel.'
        },
        seven: {
          question: 'Eski li bon pou bann lekip?',
          answer: 'Wi. Facture.mu permet ou zere plizir itilizater avek rol ek permision ki ou parametre.'
        },
        eight: {
          question: 'Eski ena sipor?',
          answer: 'Wi, nou lekip sipor disponib pou akonpagn ou par chat, email ek sant led.'
        }
      }
    },
    contact: {
      title: 'Kontak nou',
      success: 'Mersi! Ou mesaz inn bien anvoye.',
      submit: 'Avoye',
      fields: {
        name: {
          label: 'Non konplet',
          placeholder: 'Non konplet'
        },
        email: {
          label: 'Adres email',
        ...
        message: {
          label: 'Mesaz',
          placeholder: 'Ekri ou mesaz...'
        }
      },
      validation: {
        name: 'Silvouple, met ou non konplet.',
        email: 'Silvouple, met enn adres email valid.',
        message: 'Silvouple, ekri ou mesaz.'
      },
      status: {
        sending: 'Pe avoye...'
      },
      error: {
        generic: 'Ena enn problem. Silvouple re-essaye.'
      }
    },
    demo: {
      modal: {
        label: 'Vwar video demo',
        close: 'Ferme video'
      }
    },
    menu: {
    ...
    footer: {
      ...
      links: {
        features: 'Fonksionnalite',
        pricing: 'Pri',
        conditions: 'Kondision',
        privacy: 'Donne personel',
        faq: 'FAQ',
        contact: 'Kontak'
      },
      bottom: {
        rights: '© Facture.mu - Tou drwa rezerve. @2026',
        legal: 'Notis legal - CGV - Cookies'
      }
    },
    pricing_page: {
      hero: {
        title: 'Plis ki zis faktirasyon',
        subtitle: 'Pri kler, fonksionnalite kler.'
      },
      billing: {
        label: 'Sanz ant anyel ek par mwa'
      },
      plans: {
        start: {
          cta: 'Esey',
          heading: 'PLAN GRATIS INKLI',
          features: [
            '1 itilizater',
            'Ziska 5 kliyan',
            'Zestion TVA',
            'Fakti ek devi san limit',
            'Dokiman avek ou logo',
            'Kre fakti PDF ek avoy par email'
          ]
        },
        grow: {
          cta: 'Esey',
          heading: 'TOU FONKSIONNALITE GRATIS +',
          features: [
            '1 itilizater',
            'Kliyan san limit',
            'Ekspor / impor Excel',
            'Rappel otomatik',
            'Model fakti san limit',
            'Zestion ek swivi peyman'
          ]
        },
        scale: {
          cta: 'Esey',
          heading: 'TOU FONKSIONNALITE PRO+',
          features: [
            '3 itilizater',
            'Plizir devis',
            'Zestion stok',
      ...
      comparison: {
        base: 'Fonksionnalite de baz',
        advanced: 'Fonksionnalite avanse',
        values: {
          unlimited: 'Ilim.'
        },
        features: {
          remove_branding: 'Retir mansyon « Facture.mu »',
          unlimited_clients: 'Kreasyon kliyan san limit',
          online_payments: 'Asepte peyman an-lign',
          logo_documents: 'Azout ou logo lor dokiman',
          customizable_templates: 'Model dokiman personnalizab',
          item_management: 'Zestion atik',
          stock_management: 'Zestion stok',
          tax_settings: 'Parametr personel bann tax',
          recurring_billing: 'Faktirasyon rekiran',
          invoice_delivery: 'Anvoi fakti par email ek WhatsApp',
          invoice_design: 'Personnaliz design bann fakti',
          reports: 'Raport ek statistik (fakti, depans, etc.)',
          email_templates: 'Personnaliz obje ek model email',
          email_reminders: 'Rappel otomatik par email',
          attachments: 'Azout piyes zwin dan email (PDF, JPG, XLS)',
          extra_users: 'Azout itilizater siplemanter lor kont',
          einvoicing: 'Faktirasyon elektronik (e-Invoicing)',
          api_access: 'Aksè a API'
        }
      }
    }
  }
